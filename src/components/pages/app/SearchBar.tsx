      ...
      <div class="flex items-center dark:bg-zinc-800">
        <div class="relative w-full">
          ...
          <input
            ...
            class="w-full border border-gray-300 py-4 pl-8 pr-2 focus:outline-none dark:border-dark-light dark:bg-dark-light dark:text-white dark:focus:bg-dark-dark"
            type="text"
            autofocus
            autocomplete="off"
            ref={input}
