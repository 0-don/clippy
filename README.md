...
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_x64-setup.exe">
  <img src="./public/windows.png"> Windows x64
</a>
•
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_arm64-setup.exe">
  Windows ARM64
</a>
<br>
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_amd64.deb">
  <img src="./public/linux.png"> Linux x64 (deb)
</a>
•
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy-1.6.13-1.x86_64.rpm">
  Linux x64 (rpm)
</a>
•
...
•
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_amd64.AppImage">
  Linux x64 (AppImage)
</a>
<br>
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_arm64.deb">
  Linux ARM64 (deb)
</a>
•
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy-1.6.13-1.aarch64.rpm">
  Linux ARM64 (rpm)
</a>
•
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_aarch64.AppImage">
  Linux ARM64 (AppImage)
</a>
<br>
<a href="https://github.com/0-don/clippy/releases/download/v1.6.13/clippy_1.6.13_universal.dmg">
